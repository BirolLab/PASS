...
It is derived from the de novo genome assembler [SSAKE](https://github.com/birollab/SSAKE), a tractable sequence assembly algorithm for very short nucleic acid sequencing reads. 
